# IAM Module - Roles and Policies for EC2, Lambda, and GitHub Actions
...
# EC2 S3 Access Policy (for attachments bucket)
resource "aws_iam_role_policy" "ec2_s3" {
  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Resource = [
        "arn:aws:s3:::${var.attachments_bucket_id}",
        "arn:aws:s3:::${var.attachments_bucket_id}/*"
      ]
    }]
  })
...
# GitHub Actions S3 Sync Policy (for frontend bucket)
resource "aws_iam_role_policy" "github_s3" {
  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Resource = [
        "arn:aws:s3:::${var.frontend_bucket_id}",
        "arn:aws:s3:::${var.frontend_bucket_id}/*"
      ]
    }]
  })
...
# GitHub Actions CloudFront Invalidation Policy
