# Network Module - VPC, Subnets, IGW, NAT Instance, Security Groups
...
# NAT Instance (t4g.micro for Free Tier instead of NAT Gateway)
# Get latest Amazon Linux 2 ARM AMI via SSM Parameter Store
...
# Security Group for Lambda (in private subnet)
